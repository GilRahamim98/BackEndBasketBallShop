...
let OrderDetailsController = class OrderDetailsController {
    ...
    update(order_id, item_id, updateOrderDetailDto) {
        return this.orderDetailsService.update(+order_id, +item_id, updateOrderDetailDto);
    }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], OrderDetailsController.prototype, "getOrderDetailsById", null);
__decorate([
    (0, common_1.Put)(':order_id/:item_id'),
    __param(0, (0, common_1.Param)('order_id')),
    __param(1, (0, common_1.Param)('item_id')),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, update_order_detail_dto_1.UpdateOrderDetailDto]),
    __metadata("design:returntype", void 0)
], OrderDetailsController.prototype, "update", null);
__decorate([
    (0, common_1.Delete)(':order_id/:item_id'),
    __param(0, (0, common_1.Param)('order_id')),
    __param(1, (0, common_1.Param)('item_id')),
    __metadata("design:type", Function),
